                    ...
                    <div class="row business-analytics_list">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order-status pending" href="{!! route('orders') !!}">
                                ...
                                </div> <span class="count" id="placed_count"></span>
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order-status confirmed" href="{!! route('orders') !!}">
                                ...
                                </div> <span class="count" id="confirmed_count"></span>
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="order-status packaging" href="{!! route('orders') !!}">
                                ...
                                </div> <span class="count" id="shipped_count"></span>
                            </a>
                        </div>
    ...
    <script>
        ...
        getVendorId(vendorUserId).then(data => {
            ...
            $(document).ready(function() {
                ...
                db.collection('vendor_orders').where('vendorID', "==", vendorId).where('status', 'in', [
                    "Order Placed"
                ]).get().then(
                    (snapshot) => {
                ...
                ]).where('vendorID', "==", vendorId).limit(inx).get().then((snapshots) => {
                    html = '';
        ...
        async function getVendorId(vendorUser) {
            var vendorId = '';
            var ref;
            await db.collection('vendors').where('author', "==", vendorUser).get().then(async function(
                vendorSnapshots) {
        ...
        async function getTotalEarnings() {
            ...
            await db.collection('vendor_orders').where('vendorID', "==", vendorId).where('status', 'in', [
                "Order Completed"
        ...
        function buildOrderHTML(snapshots) {
            ...
            snapshots.docs.forEach((listval) => {
                ...
                html = html + '<td data-url="' + route + '" class="redirecttopage">' + val.author.firstName + ' ' +
